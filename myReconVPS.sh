...
order=("ubuntu-update" "basic-tools" "snap-refresh" "go" "python3" "airixss" "amass" "anew" "arjun" "assetfinder" "cf-check" "cdncheck" "dalfox" "dnsexpire" "dnsgen" "dnspy" "dnsvalidator" "dnsx" "exif" "ffuf" "findomain" "freq" "gau" "gauplus" "getjs" "gf" "github-subdomains" "github-endpoints" "goop" "gospider" "gowitness" "gxss" "hakcheckurl" "haklistgen" "hakrawler" "hakrevdns" "haktldextract" "httpie" "httprobe" "httpx" "jsubfinder" "katana" "knock" "mariadb-client" "meg" "mildew" "naabu" "nilo" "nmap" "notify" "nuclei" "oneforall" "paramspider" "photon" "prips" "puredns" "qsreplace" "quaithe" "rayder" "revwhoix" "sdlookup" "searchsploit" "secretfinder" "shuffledns" "subfinder" "sudomy" "sublist3r" "testssl" "trufflehog" "uncover" "unfurl" "uro" "wafw00f" "waybackurls" "wpscan" "xurlfind3r" "assetnote-wordlists" "seclists" "resolvers")
